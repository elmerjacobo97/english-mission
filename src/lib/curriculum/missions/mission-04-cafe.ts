...
export const mission04Beats: Beat[] = [
  ...
  {
    kind: "type",
    prompt: "Cami espera tu pedido. Escribe en inglés: «¿Me trae un café, por favor?»",
  ...
  {
    kind: "story",
    es: "Cami anota el café y te ofrece té. Pides uno también.",
    en: "Can I have a tea, please?",
    speaker: "you",
    vocab: [["tea", "té"]],
    character: "cami",
    mood: "happy",
  ...
  {
    kind: "story",
    es: "Cami pregunta si quieres azúcar y te trae una taza grande.",
    en: "Do you want sugar? The cup is big!",
    speaker: "cami",
    vocab: [
      ["sugar", "azúcar"],
      ["cup", "taza"],
  ...
  {
    kind: "fill",
    prompt: "Terminaste. Pides la cuenta de forma educada.",
  ...
  {
    kind: "story",
    es: "Pagas, das las gracias y sales hacia la entrevista. Coco te despide desde la ventana.",
